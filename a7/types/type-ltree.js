...
LTree.landmarks = {
	"stubs": [0.16,0.88,0.01,0.36,0.00,1.00,0.00,1.00],
	"pine": [0.4, 0.5, 0.1, 0.5],
	"oak": [0.4, 0.5, 0.1, 0.5],
	"willow": [0.4, 0.5, 0.1, 0.5]
}
LTree.labels = ["spread", "bushiness", "length_dieoff", "thickness_dieoff", "flowerHue", "petalSpread", "flowerSize", "flowerSpikiness"]
